...
1. **Nice time-frequency plots** (Eelke Spaak)

[http://eelkespaak.nl/blog/customizing-common-m-eeg-plots-part-2-the-time-frequency-representation-tfr/](http://eelkespaak.nl/blog/customizing-common-m-eeg-plots-part-2-the-time-frequency-representation-tfr/)

**2. Fundamentals of Data Visualization**

##### _Claus O. Wilke_

**FOR THE WHOLE BOOK, GO TO: http://serialmentor.com/dataviz/**
...
The entire book is written in R Markdown, using RStudio as my text editor and the **bookdown** package to turn a collection of markdown documents into a coherent whole. The book's source code is hosted on GitHub, at [https://github.com/clauswilke/dataviz](https://github.com/clauswilke/dataviz). If you notice typos or other issues, feel free to open an issue on GitHub or send me a pull request. If you do the latter, in your commit message, please add the sentence "I assign the copyright of this contribution to Claus O. Wilke," so that I can maintain the option of publishing this book in other forms.
