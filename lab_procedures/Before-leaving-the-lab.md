...
* Push the stirrup down. If not possible, press the UP-Button shortly - both orange lights will glow - you can push the stirrup now and Press DOWN-button.Release the stirrup!Press DOWN-button until gantry stops automatically at liquefaction position – which is indicated by blinking green OK-LED.

* if necessary (e.g. when liquid helium is rare) click on "finish MEG session"-Icon on Sinuhe-Desktop. Helium recycling process will start immediately!
* switch off the emergency call system (again green button)
